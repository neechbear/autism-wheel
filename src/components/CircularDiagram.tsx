  ...
  return (
    <div className="w-full max-w-4xl text-left">
      ...
      <ul className="list-disc list-outside space-y-2 mb-4 pl-8">
        ...
        <li><a href="https://www.s4nd.org/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline"><strong>The Society for Neurodiversity (S4Nd) (UK)</strong></a>: The Society for Neurodiversity (S4Nd) is a UK-based charitable incorporated organisation, run by and for neurodivergent people, that supports neurodivergent individuals, their families, and allies by providing community, resources, and advocacy.</li>
        ...
        <li><a href="https://awnnetwork.org/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline"><strong>Autistic Women's Network (AWN) (US)</strong></a>: A US-based organization that provides support and resources for autistic women and gender-diverse individuals.</li>
      </ul>
